<script>
    function changeButtons(e1) {
        if (e1.innerHTML === "Edit") {
            e1.innerHTML = "Cancel";
            document.getElementById("add").innerHTML = "Update Monthly Income Source";
            document.getElementById("update").value=e1.id;
        } else {
            e1.innerHTML = "Edit";
            document.getElementById("add").innerHTML = "Add New Monthly Income Source";
...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <h2>Please enter your monthly recurring income (annuities, pensions, jobs, etc.)</h2>


            <table class="table table-striped">
                <thead class="thead-dark">
                <tr>
                    <th scope="col"><center>Income Source</center></th>
            ...
            <form action="./recurring_income" method="post">
                ...
                <button type="submit" class="btn btn-primary" id="add">Add New Monthly Income Source</button>
            </form>
        </div>
    </div>
</div>