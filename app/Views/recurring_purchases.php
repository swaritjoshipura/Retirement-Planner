<script>
    function changeButtons(e1) {
        if (e1.innerHTML === "Edit") {
            e1.innerHTML = "Cancel";
            document.getElementById("add").innerHTML = "Update Monthly Recurring Purchase";
            document.getElementById("update").value=e1.id;
        } else {
            e1.innerHTML = "Edit";
            document.getElementById("add").innerHTML = "Add New Monthly Recurring Purchase";
...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <h2>Please enter your monthly recurring purchases (utilities, rent, etc.)</h2>
            ...
            <form action="./recurring_purchases" method="post">
                ...
                <button type="submit" class="btn btn-primary" id="add">Add New Monthly Recurring Purchase</button>
            </form>
        </div>
    </div>
</div>